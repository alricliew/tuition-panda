...
// GENERAL KEY
export const MY_REQUEST_CODE = 1234; // (Integer)
export const RegistrationUrl = "https://golearn.com.my/join-us/";
export const ID_KEY = "id";
export const FIREBASE_TUTOR_KEY = "Tutor";
export const FIREBASE_USERS_KEY = "Users";
export const FIREBASE_CONTACTS_KEY = "Contacts";

// Tutor Personal Details (9) excluded NRIC_KEY
export const TOKEN_KEY = "token";
export const NAME_KEY = "name";
export const FULL_NAME_AS_NRIC_KEY = "aFullNameAsNric";
export const NRIC_KEY = "nric";
export const EMAIL_KEY = "email";
export const PHONE_KEY = "phone";
export const AGE_KEY = "age";
export const GENDER_KEY = "gender";
export const ADDRESS_KEY = "address";
export const ADDRESS_1_KEY = "address1";
export const ADDRESS_2_KEY = "address2";
export const ADDRESS_POSTCODE_KEY = "addressPostCode";
export const ADDRESS_STATE_KEY = "addressState";
export const IMAGE_KEY = "imgUrl";
export const RATING_KEY = "rating";
export const RATING_TIMES_KEY = "ratingTimes";
export const RATING_FINAL_KEY = "ratingFinal"; // NEW FEATURE 2.0 - Used for sorting in ../find-tutor
export const PROFILE_STATUS_KEY = "profileStatus";
export const AGENT_KEY = "agent";
export const ACCOUNT_STATUS_KEY = "accountStatus";
    // Value of ACCOUNT_STATUS_KEY
    export const DEACTIVATED_ACCOUNT_STATUS_KEY = "deactivated";
    export const ACTIVE_ACCOUNT_STATUS_KEY = "activate"; //"active";
    export const SUSPENDED_ACCOUNT_STATUS_KEY = "suspended";
    export const PREMIUM_ACCOUNT_1_STATUS_KEY = "premium1"; // VIP Equivalent
    export const PREMIUM_ACCOUNT_2_STATUS_KEY = "premium2"; // VVIP Equivalent
    export const PREMIUM_ACCOUNT_3_STATUS_KEY = "premium3"; // VVVIP Equivalent
    export const PREMIUM_ACCOUNT_1_ACTIVE_STATUS_KEY = "premium1act";
    export const PREMIUM_ACCOUNT_2_ACTIVE_STATUS_KEY = "premium2act";
    export const PREMIUM_ACCOUNT_3_ACTIVE_STATUS_KEY = "premium3act";
// NEW FEATURE 2.0 - Used for sorting in ../find-tutor
export const SYSTEM_LAST_ONLINE_KEY = "uLastOnline";
// NEW FEATURE 2.0 - Used for general time table
export const TUTOR_TIME_SLOT_MON_8AM_KEY  = "tMon8am";
export const TUTOR_TIME_SLOT_MON_12PM_KEY = "tMon12pm";
export const TUTOR_TIME_SLOT_MON_3PM_KEY  = "tMon3pm";
export const TUTOR_TIME_SLOT_MON_6PM_KEY  = "tMon6pm";
export const TUTOR_TIME_SLOT_TUE_8AM_KEY  = "tTue8am";
export const TUTOR_TIME_SLOT_TUE_12PM_KEY = "tTue12pm";
export const TUTOR_TIME_SLOT_TUE_3PM_KEY  = "tTue3pm";
export const TUTOR_TIME_SLOT_TUE_6PM_KEY  = "tTue6pm";
export const TUTOR_TIME_SLOT_WED_8AM_KEY  = "tWed8am";
export const TUTOR_TIME_SLOT_WED_12PM_KEY = "tWed12pm";
export const TUTOR_TIME_SLOT_WED_3PM_KEY  = "tWed3pm";
export const TUTOR_TIME_SLOT_WED_6PM_KEY  = "tWed6pm";
export const TUTOR_TIME_SLOT_THU_8AM_KEY  = "tThu8am";
export const TUTOR_TIME_SLOT_THU_12PM_KEY = "tThu12pm";
export const TUTOR_TIME_SLOT_THU_3PM_KEY  = "tThu3pm";
export const TUTOR_TIME_SLOT_THU_6PM_KEY  = "tThu6pm";
export const TUTOR_TIME_SLOT_FRI_8AM_KEY  = "tFri8am";
export const TUTOR_TIME_SLOT_FRI_12PM_KEY = "tFri12pm";
export const TUTOR_TIME_SLOT_FRI_3PM_KEY  = "tFri3pm";
export const TUTOR_TIME_SLOT_FRI_6PM_KEY  = "tFri6pm";
export const TUTOR_TIME_SLOT_SAT_8AM_KEY  = "tSat8am";
export const TUTOR_TIME_SLOT_SAT_12PM_KEY = "tSat12pm";
export const TUTOR_TIME_SLOT_SAT_3PM_KEY  = "tSat3pm";
export const TUTOR_TIME_SLOT_SAT_6PM_KEY  = "tSat6pm";
export const TUTOR_TIME_SLOT_SUN_8AM_KEY  = "tSun8am";
export const TUTOR_TIME_SLOT_SUN_12PM_KEY = "tSun12pm";
export const TUTOR_TIME_SLOT_SUN_3PM_KEY  = "tSun3pm";
export const TUTOR_TIME_SLOT_SUN_6PM_KEY  =  "tSun6pm";
    // Value of TUTOR_TIME_SLOT_<Day of Week>_<Time Slot>_KEY
    export const TUTOR_TIME_SLOT_OPEN_KEY = "open";
    export const TUTOR_TIME_SLOT_BUSY_KEY = "busy";
    export const TUTOR_TIME_SLOT_CLOSE_KEY = "closed";
// NEW FEATURE 2.0
export const ADMIN_WEB_URL_KEY = "aWebUrl";
export const ADMIN_PREMIUM_SUBJECT_LIMIT_KEY = "aPremiumSubjectLimit"; // Default 10
export const ADMIN_PREMIUM_CONNECT_LIMIT_KEY = "aPremiumConnectLimit";
export const ADMIN_TOTAL_SUBJECT_LIMIT_KEY = "aTotalSubjectLimit";  // Default 40
export const ADMIN_TOTAL_CONNECT_LIMIT_KEY = "aTotalConnectLimit";
export const ADMIN_PREFFERED_AREA_LIMIT_KEY = "aPreferredAreaLimit"; // Default 5
export const ADMIN_PREFERRED_SUBJECT_LIMIT_KEY = "aPreferredSubjectLimit";// Default 20
...
export const CHECK_ONLINE_GROUP_KEY = "modeOnlineGroup";
    export const MODE_HOME_TUTOR_TO_STUDENT = "modeHomeTutorToStudent";
    export const MODE_HOME_STUDENT_TO_TUTOR = "modeHomeStudentToTutor"
    export const MODE_GROUP = "modeGroup"
    export const MODE_ONLINE = "modeOnline"
    export const MODE_ONLINE_GROUP = "modeOnlineGroup"
...
// NEW FEATURE 2.0 End
export const YEARS_EXPERIENCE_KEY="yearsExperience";
export const TUTORING_EXPERIENCE_KEY="tutoringExperience";
export const TUTORING_APPROACH_KEY="tutoringApproach";
export const QUALIFICATION_KEY="qualification";
export const PREFERED_AREA_LIST_KEY = "preferedAreaList";
